...
- published to github
- built telemetry toolkit as cli... (parser, validator, analyzer, reporter)
- ./docs/textbook/ exists to hold lessons from claude
...
**Logger** — who is talking (telemetry.main, telemetry.validator). Named, hierarchical by dots.
**Level** — how important this is.
**Handler** — where it goes (stderr, a file, syslog, nowhere).
**Formatter** — what it looks like.
