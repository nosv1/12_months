...
20260921 1702 - 1852 (1.8 hours -- week-2 deliverable closed: telemetry/ README rewritten against the code, CI green on GitHub Actions (ruff, mypy, pytest, sample run, then install-as-tool + strict-JSON customer run for §8); estimates log started; textbook 19)
