...
| 09-25 | `shared_ptr`: predict `use_count` through copy/scope/move/reset, whether the pointee is copied, and when the destructor runs | code-new | — | 20–25 min | open | — | Given 17:55, after he chose to keep going. Guided, predict-then-run. |
