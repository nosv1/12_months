...
| 09-24 | Move semantics, core: `std::move` a `unique_ptr`, observe the moved-from state, then a noisy class showing copy vs move ctor (predict which runs) | code-new | — | 30–40 min (asked for mine; he said he was getting antsy) | deferred | — | Not started 09-24: he stopped at 18:08. Guided session — reactive kind, so expect under 1x. |
