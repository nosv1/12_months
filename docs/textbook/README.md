...
| 22 | [Parsing input that fights back](22-parsing-input-that-fights-back.md) | 3 | `conflicting declaration ‘RobotID* row’` naming a variable nobody wrote, and a segfault on line 301 |
